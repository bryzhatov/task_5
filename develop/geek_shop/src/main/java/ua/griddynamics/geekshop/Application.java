...
public class Application {
    public static void main(String[] args) throws IOException {
        ...
        httpServer.addReaction("/", RequestMethods.GET, pageController::getIndex);
        httpServer.addReaction("/v1/categories", RequestMethods.GET, categoryController::getCategories);
        httpServer.addReaction("/v1/categories/main", RequestMethods.GET, categoryController::getMainCategories);
